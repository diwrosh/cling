 ...
 */
// @Alternative
public class DefaultUpnpServiceConfiguration implements
    UpnpServiceConfiguration
{

  private static Logger log = Logger
      .getLogger(DefaultUpnpServiceConfiguration.class.getName());
  ...
  public static class ClingExecutor extends ThreadPoolExecutor
  {
    ...
    protected void afterExecute(Runnable runnable, Throwable throwable) {
      ...
      if (throwable != null) {
        // Log only
        log.warning("Thread terminated " + runnable
            + " abruptly with exception: " + throwable);
