...
import org.teleal.cling.support.model.SearchResult;
...
public abstract class Search extends ActionCallback {
    ...
    public void success(ActionInvocation actionInvocation) {
        ...
        // (v10) Null pointer exception on search success with empty result
        Object resVal = actionInvocation.getOutput("Result").getValue();
