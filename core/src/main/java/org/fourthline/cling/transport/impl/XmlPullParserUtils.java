...
public class XmlPullParserUtils {
  ...
  final private static Logger _log = Logger.getLogger(XmlPullParserUtils.class.getSimpleName());
	...
	static {
      ...
      _log.severe("cannot create XmlPullParserFactory instance: " + e);
		}
	}
	...
	static public void setSerializerIndentation(XmlSerializer serializer, int indent) {
        ...
        _log.warning("error setting feature of XmlSerializer: " + e);
			}
	...
	public static  String fixXMLEntities(String xml) {
    	...
    	if(isFixed) {
      _log.warning("fixed badly encoded entities in XML");
    	}
